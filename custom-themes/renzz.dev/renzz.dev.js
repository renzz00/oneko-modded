...
nekoEl.addEventListener('mousemove', function(event) {
  event.preventDefault();
  event.currentTarget.style.left = event.pageX + 'px';
  event.currentTarget.style.top = event.pageY + 'px';
});
nekoEl.addEventListener('mouseup', function(event) {
  event.preventDefault();
